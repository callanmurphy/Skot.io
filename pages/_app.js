      ...
      {user ? (
        <div id="nav-bar">
          ...
          <div id="nav-hamburger">
            <Image
              src={hamburgerOpen ? "/x.svg" : "/hamburger.svg"}
              alt="hamburger menu"
              width="30"
              height="30"
          ...
          <div id="nav-menu">
            <ul>
              {pages.map((page, index) => (
                <li key={index}>
                  <Link href={"/" + page}>
                    <a
                      id={
                        router.pathname === "/" + page ? "current-page" : null
                      }
                    >
              ...
              >
                {/* <Link href={"/login"}> */}
                <div className="dropdown-hover-icon">
                  <Image
                    src={"/profile.svg"}
                    alt="Site Logo"
                    width="35"
      ...
      {hamburgerOpen && (
        <div className={"hamburgerOpen"}>
          {pages.map((page, index) => (
            <li key={index}>
              <Link href={"/" + page}>
                <a id={router.pathname === "/" + page ? "current-page" : null}>
                  {page.charAt(0).toUpperCase() + page.slice(1)}
                </a>
              </Link>
            </li>
